    ...
    <div class="card card-primary card-outline text-sm">
      ...
      <div class="card-body">
        ...
        <div class="row">
          ...
          <?php } ?>
          <?php if (isset($config['setting']['google_play']) && $config['setting']['google_play'] == true) { ?>
            <div class="form-group col-md-4 col-sm-6">
              <label for="google_play">Link google play:</label>
              <input type="text" class="form-control text-sm" name="data[options][google_play]" id="google_play" placeholder="Link google play" value="<?= (!empty($flash->has('google_play'))) ? $flash->get('google_play') : @$options['google_play'] ?>" required>
            </div>
          <?php } ?>
          <?php if (isset($config['setting']['apple_store']) && $config['setting']['apple_store'] == true) { ?>
            <div class="form-group col-md-4 col-sm-6">
              <label for="apple_store">Link apple store:</label>
              <input type="text" class="form-control text-sm" name="data[options][apple_store]" id="apple_store" placeholder="Link apple store" value="<?= (!empty($flash->has('apple_store'))) ? $flash->get('apple_store') : @$options['apple_store'] ?>" required>
            </div>
          <?php } ?>
