    ...
    <div class="row">
      <div class="<?= $colLeft ?>">
        ...
        <div class="card card-primary card-outline text-sm">
          <div class="card-header">
            <h3 class="card-title"><?= noidung ?> <span class="text-lowercase"><?= $config['product'][$type]['title_main_list'] ?></span></h3>
      ...
      <div class="<?= $colRight ?>">
        <?php if (isset($config['product'][$type]['images_list']) && $config['product'][$type]['images_list'] == true) { ?>
          <div class="card card-primary card-outline text-sm">
            <div class="card-header">
              <h3 class="card-title"><?= hinhanh ?> <span class="text-lowercase"><?= $config['product'][$type]['title_main_list'] ?></span></h3>
              <div class="card-tools">
                <button type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fas fa-minus"></i></button>
              </div>
            </div>
            <div class="card-body">
              ...
              $photoDetail['table'] = 'product_list';
