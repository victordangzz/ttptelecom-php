  ...
  <form class="validation-form" novalidate method="post" action="<?= $linkSave ?>" enctype="multipart/form-data">
    ...
    <div class="row">
      <div class="col-xl-8">
        ...
        <div class="card card-primary card-outline text-sm">
          <div class="card-header">
            <h3 class="card-title"><?= noidung ?> <span class="text-lowercase"><?= $config['product'][$type]['title_main_sub'] ?></span></h3>
      ...
      <div class="col-xl-4">
        <div class="card card-primary card-outline text-sm">
          <div class="card-header">
            <h3 class="card-title">Danh mục <span class="text-lowercase"><?= $config['product'][$type]['title_main_sub'] ?></span></h3>
            <div class="card-tools">
              <button type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fas fa-minus"></i></button>
            </div>
          </div>
        ...
        <?php if (isset($config['product'][$type]['images_sub']) && $config['product'][$type]['images_sub'] == true) { ?>
          <div class="card card-primary card-outline text-sm">
            <div class="card-header">
              <h3 class="card-title"><?= hinhanh ?> <span class="text-lowercase"><?= $config['product'][$type]['title_main_sub'] ?></span></h3>
              <div class="card-tools">
                <button type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fas fa-minus"></i></button>
              </div>
            </div>
