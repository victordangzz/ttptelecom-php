					...
					},
					{
						...
						value: function (t, e, i) {
							var a,
								...
								h = i.opacity;
							if (
								(null === (a = s.config.chart.dropShadow.enabledOnSeries) ||
								void 0 === a
									? void 0
									: a.length) > 0 &&
								-1 === s.config.chart.dropShadow.enabledOnSeries.indexOf(e)
							)
								return t;
							var c = t
								.flood(Array.isArray(l) ? l[e] : l, h)
					...
					},
					{
						...
						value: function (t, e) {
							...
							if (
								...
								return t;
							if (
								(null === (i = d.config.chart.dropShadow.enabledOnSeries) ||
								void 0 === i
									? void 0
									: i.length) > 0 &&
								-1 ===
									(null === (a = d.config.chart.dropShadow.enabledOnSeries) ||
									void 0 === a
										? void 0
										: a.indexOf(s))
							)
					...
					[
							...
							value: function (t) {
								...
								return (
									Array.isArray(r)
										...
										: (g &&
												(y = this.getTextBasedOnMaxWidth(e({ text: r }, k))),
										  (w = x
						...
						},
						{
							...
							value: function (t, e, i, a, s) {
								...
								return (
									n.attr({ cx: t, cy: e, class: s.class ? s.class : "" }), n
								);
							},
						},
						{
							...
							value: function (t, i, a) {
								...
								var s = a.pSize || 0,
									r = null;
								if ("cross" === (null == a ? void 0 : a.shape))
									r = this.drawXMarker(
										t,
										i,
										null == a ? void 0 : a.shape,
										1.8 * s,
										e(e({}, a), {}, { pointStrokeColor: a.pointFillColor })
									);
								else if ("plus" === (null == a ? void 0 : a.shape))
									r = this.drawXMarker(
										t,
										i,
										null == a ? void 0 : a.shape,
								...
								else if ("line" === (null == a ? void 0 : a.shape))
									(r = this.drawLine(
										t - s,
										i,
										t + s,
										i,
										a.pointFillColor,
										a.pointStrokeDashArray,
										a.pointStrokeWidth,
										a.pointStrokeLineCap
									)).attr({ cx: t, cy: i, class: a.class ? a.class : "" });
									...
									("circle" !== a.shape && a.shape) ||
										(x.isNumber(i) || ((s = 0), (i = 0)),
										(r = this.drawCircle(s, {
											cx: t,
											cy: i,
											class: a.class ? a.class : "",
					...
					[
						...
						},
						{
							...
							value: function () {
								...
								for (
									var n = e.yaxis.length - 1, l = 0;
									l < o.length && ((n = o[l]), (i[n] = []), s);
									l++
								) {
									var h = s[0];
												...
												a.seriesLog.forEach(function (t, e) {
													t.forEach(function (t) {
														i.config.yaxis[e] &&
															...
															((n = Math.max(t, n)), (l = Math.min(t, l)));
													});
												}),
												(o = Math.pow(
													a.yRange[s],
													Math.abs(l - n) / a.yRange[s]
												)),
						...
						},
						{
							...
							value: function (t, e, i) {
								...
								null !== (s = e) && void 0 !== s && s.annotations) &&
									...
									null !== (r = e) &&
										void 0 !== r &&
										null !== (o = r.annotations) &&
										void 0 !== o &&
										o.xaxis &&
										(e = t.extendXAxisAnnotations(e)),
									null !== (n = e) &&
										void 0 !== n &&
										null !== (l = n.annotations) &&
										void 0 !== l &&
										l.points &&
						...
						value: function (t, e) {
							...
							if (this.annoCtx.invertAxis) {
								...
								(i = l
									...
									: (r.globals.gridHeight / o.length - 1) * (n + 1) -
									  r.globals.barHeight),
									void 0 !== e.seriesIndex &&
										r.globals.barHeight &&
										(i =
											i -
											(r.globals.barHeight / 2) *
												(r.globals.series.length - 1) +
											r.globals.barHeight * e.seriesIndex);
							} else {
								var h,
								...
								if (r.config.yaxis[e.yAxisIndex].logarithmic)
									h =
										(a = new y(this.annoCtx.ctx).getLogVal(
											r.config.yaxis[e.yAxisIndex].logBase,
											a,
											c
										)) / r.globals.yLogRatio[c];
								else
									h =
										(a - r.globals.minYArr[c]) /
										(r.globals.yRange[c] / r.globals.gridHeight);
								h > r.globals.gridHeight
									? ((h = r.globals.gridHeight), (s = !0))
									: h < 0 && ((h = 0), (s = !0)),
					...
					},
					{
						...
						value: function (t, e) {
							var i,
								...
								l = !1;
							return (
								(i = this.annoCtx.inversedReversedAxis
									? (o - a) / (n / s.globals.gridWidth)
									: (a - r) / (n / s.globals.gridWidth)),
								("category" !== s.config.xaxis.type &&
									!s.config.xaxis.convertedCatToNumeric) ||
									this.annoCtx.invertAxis ||
									s.globals.dataFormatXNumeric ||
								...
								void 0 !== e.seriesIndex &&
									...
									(i =
										i -
										(s.globals.barWidth / 2) * (s.globals.series.length - 1) +
										s.globals.barWidth * e.seriesIndex),
								i > s.globals.gridWidth
									? ((i = s.globals.gridWidth), (l = !0))
									: i < 0 && ((i = 0), (l = !0)),
								{ x: i, clipped: l }
							);
						},
						...
						value: function (t, e, i, a, s, r, o) {
							...
							if (
								(n.globals.isBarHorizontal
									? (h = 0)
									: "heatmap" === n.config.chart.type && (h += r / 2),
								a.show && e > 0)
							) {
				...
				r(t, [
					{
						...
						value: function (t, e, i) {
							...
							if (null === t.y2 || void 0 === t.y2) {
								...
								if (
									((a = (o = this.helpers.getY1Y2("y2", t)).yP),
									(h = o.clipped),
									a > n)
								) {
									var u = n;
		...
		z = function (t) {
			...
			i) ||
				("datetime" === l.config.xaxis.type &&
					(d = new S(a).xLabelFormat(l.globals.ttKeyFormatter, d, d, {
						i: void 0,
						...
						value: function (t) {
							...
							if (a && "object" === i(a)) {
								...
								(m =
									...
									((null !==
										(f = (a = this.checkForCatToNumericXAxis(
											this.chartType,
											m,
											a
										)).chart.sparkline) &&
										...
										o.config.series[n].data[u] &&
											...
											o.config.series[n].data[u].strokeColor &&
												(f.pointStrokeColor =
													o.config.series[n].data[u].strokeColor)),
											a && (f.pSize = a),
											(l.x[g] < -o.globals.markers.largestSize ||
												l.x[g] >
													o.globals.gridWidth + o.globals.markers.largestSize ||
												l.y[g] < -o.globals.markers.largestSize ||
												l.y[g] >
													o.globals.gridHeight +
														o.globals.markers.largestSize) &&
												(f.pSize = 0),
				...
				r(t, [
					...
					},
					{
						...
						value: function (t, e, i, a, s, r) {
							...
							if (
								(o.config.series[n].data[s] &&
									o.config.series[n].data[s].fillColor &&
									(p = o.config.series[n].data[s].fillColor),
								f.attr({ fill: p, r: i }),
							...
							return (
								f.attr({ rel: s, j: s, index: a, "default-marker-size": i }),
					...
					},
					{
						...
						value: function (t) {
							...
							((("bar" === e.config.chart.type ||
								...
								(y = e.globals.dataLabels.style.colors[o]),
								"function" == typeof y &&
									(y = y({
							...
							if (
								...
								e.globals.isSlopeChart &&
									(0 !== o && (w = -2 * d.offsetX + 5),
									0 !== o &&
										o !== e.config.series[r].data.length - 1 &&
										(w = 0)),
								b.drawnextLabel)
							) {
								if (
						...
						value: function (t, e) {
							...
							if ("mousemove" === t.type) {
								...
								for (var h = 0; h < a.length; h++)
									a[h].classList.add(this.legendInactiveClass);
								null !== r &&
				...
				r(t, [
					...
					},
					{
						...
						value: function () {
							...
							for (
								var a = 0;
								a < e.seriesYAxisMap.length &&
								-1 !== e.ignoreYAxisIndexes.indexOf(a);
						...
						value: function (t, e) {
							...
							if (
								...
								((t === Number.MIN_VALUE && 0 === e) ||
									...
									((t = x.isNumber(i.min) ? i.min : 0),
									(e = x.isNumber(i.max) ? i.max : t + g),
							...
							var f = g,
								b = Math.abs(e - t);
							if (i.forceNiceScale) {
								!s && t > 0 && t / b < 0.15 && ((t = 0), (s = !0)),
									!r && e < 0 && -e / b < 0.15 && ((e = 0), (r = !0)),
									(b = Math.abs(e - t));
							}
							var v = b / f,
								m = v,
								...
								if (s || r) {
									if (r)
										if (d) t = e - v * f;
											...
											var P = t;
											(t = v * Math.floor(t / v)),
												Math.abs(e - t) / x.getGCD(b, v) > a &&
													((t = e - v * g), (t += v * Math.floor((P - t) / v)));
										}
									else if (s)
										if (d) e = t + v * f;
										else {
							...
							if (
								(d ||
									s ||
									r ||
									((f = Math.ceil((b - n) / (v + n))) > 16 &&
										x.getPrimeFactors(f).length < 2 &&
										f++),
								!d &&
									i.forceNiceScale &&
									0 === h.yValueDecimal &&
									f > b &&
									((f = b), (v = Math.round(b / f))),
								...
								t: for (var Y = 0; Y < X; Y++)
									for (var F = 0; F <= X - Y; F++) {
										for (
											var R = Math.min(F + Y, X), H = E, D = 1, O = F;
											O <= R;
											O++
										)
											D *= z[O];
									...
									a.forEach(function (t) {
										...
										a.length > 0
											? (function () {
													...
													void 0 !== e.yaxis[o].min &&
														(c =
															"function" == typeof e.yaxis[o].min
																? e.yaxis[o].min(c)
																: e.yaxis[o].min),
														void 0 !== e.yaxis[o].max &&
															(d =
																"function" == typeof e.yaxis[o].max
																	? e.yaxis[o].max(d)
																	: e.yaxis[o].max),
														...
														t.setYScaleForIndex(o, c, d),
														a.forEach(function (t) {
															(s[t] = i.yAxisScale[o].niceMin),
																(r[t] = i.yAxisScale[o].niceMax);
														});
											  })()
					...
					},
					{
						...
						value: function (t) {
							...
							if (r.seriesX.length >= a) {
								...
								(l = 0),
									(h =
										(c = u(
											new Set(
												(d = []).concat.apply(d, u(r.seriesX.slice(t, a)))
											)
										)).length - 1);
								var p =
									null === (g = r.brushSource) || void 0 === g
										? void 0
										: g.w.config.chart.brush;
								if (
									(s.chart.zoom.enabled && s.chart.zoom.autoScaleYaxis) ||
									(null != p && p.enabled && null != p && p.autoScaleYaxis)
								) {
									if (s.xaxis.min)
							...
							"candlestick" === s.chart.type
								? ((b = r.seriesCandleL), (v = r.seriesCandleH))
								: "boxPlot" === s.chart.type
								? ((b = r.seriesCandleO), (v = r.seriesCandleC))
								: r.isRangeData &&
								  ((b = r.seriesRangeStart), (v = r.seriesRangeEnd));
							for (var m = t; m < a; m++) {
								...
								for (var w = l; w <= h && w < r.series[m].length; w++) {
									...
									if (null !== k && x.isNumber(k)) {
										switch (
											...
											case "candlestick":
												void 0 !== r.seriesCandleC[m][w] &&
													((o = Math.max(o, r.seriesCandleH[m][w])),
													(e = Math.min(e, r.seriesCandleL[m][w])));
												break;
											case "boxPlot":
												void 0 !== r.seriesCandleC[m][w] &&
													((o = Math.max(o, r.seriesCandleC[m][w])),
										...
										y &&
											...
											"rangeArea" !== y &&
											"rangeBar" !== y &&
											((o = Math.max(o, r.series[m][w])),
											(e = Math.min(e, r.series[m][w]))),
											(i = o),
											r.seriesGoals[m] &&
												r.seriesGoals[m][w] &&
												Array.isArray(r.seriesGoals[m][w]) &&
												r.seriesGoals[m][w].forEach(function (t) {
													n !== Number.MIN_VALUE &&
								...
								("bar" !== y && "column" !== y) ||
									(n < 0 && o < 0 && ((o = 0), (i = Math.max(i, 0))),
									n === Number.MIN_VALUE && ((n = 0), (e = Math.min(e, 0))));
							}
							return (
												...
												for (
													...
													void 0 === a[i][o] && ((a[i][o] = 0), (s[i][o] = 0)),
														((t.w.config.chart.stacked && !e.comboCharts) ||
															...
															(e.series[r][o] > 0
																? (a[i][o] += parseFloat(e.series[r][o]) + 1e-4)
																: (s[i][o] += parseFloat(e.series[r][o])));
												}
											});
								}),
				...
				r(t, [
					{
						...
						value: function (t) {
							...
							if (i.config.yaxis[t].labels.show) {
								...
								i.globals.isBarHorizontal
									? (f = 0)
									: "heatmap" === i.config.chart.type && (f -= d / 2),
									(f +=
										parseInt(i.config.yaxis[t].labels.style.fontSize, 10) / 3);
								for (
									var x = function (l) {
											var x = u[l];
											x = g(x, l, i);
									...
									o = function () {
										...
										if (o > a) {
											...
											for (var h = 0; h < s.length; h++)
												o < s[h].breakpoint &&
													((t = y.extendArrayProps(r, s[h].options, i)),
													(t = x.extend(i.config, t)),
													e.overrideResponsiveOptions(t));
									};
								if (t) {
						...
						value: function () {
							...
							e.config.series.forEach(function (s, r) {
								s.data.forEach(function (s, o) {
									var n;
									(n = e.globals.series[r][o]),
										(a = e.config.dataLabels.formatter(n, {
											ctx: t.dCtx.ctx,
											seriesIndex: r,
											dataPointIndex: o,
											w: e,
									...
									if (
										...
										var c = e.globals.yLabelFormatters[o],
											...
											g = l.result.reduce(function (t, e) {
												var i, a;
												return (null === (i = String(c(t, n))) || void 0 === i
													? void 0
													: i.length) >
													(null === (a = String(c(e, n))) || void 0 === a
														? void 0
														: a.length)
													? t
													: e;
											...
											u = (g = c(g, n));
										if (
											((void 0 !== g && 0 !== g.length) || (g = l.niceMax),
											e.globals.isBarHorizontal)
										) {
											a = 0;
				...
				r(t, [
					{
						...
						value: function (t) {
							...
							a.comboBarCount > 0 && (n = a.comboBarCount),
							...
							if (l && a.isXNumeric && !a.isBarHorizontal && n > 0 && 0 !== h) {
								...
								h <= 3 && (h = a.dataPoints),
									(c = h / t),
									a.minXDiff && a.minXDiff / c > 0 && (d = a.minXDiff / c),
									d > t / 2 && (d /= 2),
									(o =
										(d * parseInt(i.plotOptions.bar.columnWidth, 10)) / 100) <
										1 && (o = 1),
									(a.barPadForNumericAxis = o);
							}
							return o;
						},
					},
				...
				r(t, [
					{
						...
						value: function () {
							...
							var a = Array.isArray(e.config.stroke.width)
								? Math.max.apply(Math, u(e.config.stroke.width))
					...
					},
					{
						...
						value: function () {
							...
							if (!i.legend.show || i.legend.floating) {
								e.gridHeight =
									e.svgHeight - i.grid.padding.top - i.grid.padding.bottom;
								var n = e.dom.elWrap.getBoundingClientRect().width;
								return (
									(e.gridWidth =
										Math.min(n, e.gridHeight) -
										i.grid.padding.left -
						...
						value: function (t) {
							...
							if (s.axisCharts) {
								...
								if (o && o.show && o.showAlways)
									s.ancillaryCollapsedSeriesIndices.indexOf(i) < 0 &&
										(s.ancillaryCollapsedSeries.push({
											index: i,
											data: r[i].data.slice(),
								...
								s.collapsedSeries.push({ index: i, data: r[i] }),
									s.collapsedSeriesIndices.push(i);
							for (var l = e.childNodes, h = 0; h < l.length; h++)
								l[h].classList.contains("apexcharts-series-markers-wrap") &&
									(l[h].classList.contains("apexcharts-hide")
										? l[h].classList.remove("apexcharts-hide")
										: l[h].classList.add("apexcharts-hide"));
							(s.allSeriesCollapsed =
								s.collapsedSeries.length + s.ancillaryCollapsedSeries.length ===
					...
					},
					{
						...
						value: function (t) {
							...
							var o = s.config.legend.markers.shape || s.config.markers.shape,
								...
								u = r.style;
							(u.height =
								(Array.isArray(n) ? 2 * parseFloat(n[i]) : 2 * parseFloat(n)) +
								"px"),
								(u.width =
									(Array.isArray(n)
										? 2 * parseFloat(n[i])
										: 2 * parseFloat(n)) + "px"),
								(u.left =
									(Array.isArray(l) ? parseFloat(l[i]) : parseFloat(l)) + "px"),
								(u.top =
									(Array.isArray(h) ? parseFloat(h[i]) : parseFloat(h)) + "px"),
								(u.borderWidth = Array.isArray(c) ? c[i] : c),
								(u.borderColor = Array.isArray(d) ? d[i] : d),
								(u.borderRadius = Array.isArray(g)
									? parseFloat(g[i]) + "px"
									: parseFloat(g) + "px"),
								s.config.legend.markers.customHTML &&
									((u.background = "transparent"),
									Array.isArray(s.config.legend.markers.customHTML)
										? s.config.legend.markers.customHTML[i] &&
										  (r.innerHTML = s.config.legend.markers.customHTML[i]())
										: (r.innerHTML = s.config.legend.markers.customHTML()));
							var p = o;
							if ((Array.isArray(o) && (p = o[i]), "circle" !== p)) {
								...
								(u.color = a[i]),
									...
									s.config.legend.markers.customHTML ||
										((u.background = a[i]),
										u.setProperty("background", a[i], "important"),
										void 0 !== s.globals.seriesColors[i] &&
											((u.background = s.globals.seriesColors[i]),
											(u.color = s.globals.seriesColors[i])));
							return r;
						},
					},
					{
						...
						value: function () {
							var t = this,
								...
								s = e.config.legend.markers.fillColors
							...
							for (
								...
								v.classList.add("apexcharts-legend-text"),
									(v.innerHTML = Array.isArray(c) ? c.join(" ") : c);
								var w = e.config.legend.labels.useSeriesColors
									? e.globals.colors[l]
								...
								w || (w = e.config.chart.foreColor),
									(v.style.color = w),
									(v.style.fontSize =
										parseFloat(e.config.legend.fontSize) + "px"),
									(v.style.fontWeight = e.config.legend.fontWeight),
									(v.style.fontFamily = i || e.config.chart.fontFamily),
									m.setAttrs(v, {
										rel: l + 1,
										i: l,
								...
								if (!e.config.legend.showForZeroSeries)
									0 === k.getSeriesTotalByIndex(l) &&
										k.seriesHaveSameValues(l) &&
										!k.isSeriesNull(l) &&
										-1 === e.globals.collapsedSeriesIndices.indexOf(l) &&
										-1 ===
											e.globals.ancillaryCollapsedSeriesIndices.indexOf(l) &&
										b.classList.add("apexcharts-hidden-zero-series");
								e.config.legend.showForNullSeries ||
									(k.isSeriesNull(l) &&
										-1 === e.globals.collapsedSeriesIndices.indexOf(l) &&
										-1 ===
											e.globals.ancillaryCollapsedSeriesIndices.indexOf(l) &&
										b.classList.add("apexcharts-hidden-null-series")),
									e.globals.dom.elLegendWrap.appendChild(b),
									...
									(d || g) && b.classList.add("apexcharts-inactive-legend"),
									e.config.legend.onItemClick.toggleDataSeries ||
										b.classList.add("apexcharts-no-click");
							}
										...
										function () {
											...
											a.globals.isRangeBar
												? ((t =
														...
														(h.left - l.left) * s.invertedYRatio),
												  (e =
														a.globals.yAxisScale[0].niceMin +
														(h.right - l.left) * s.invertedYRatio),
												  (o = 0),
												  (n = 1))
												: ((t =
														a.globals.xAxisScale.niceMin +
														(h.left - l.left) * s.xRatio),
												  (e =
														a.globals.xAxisScale.niceMin +
														(h.right - l.left) * s.xRatio),
												  (o =
														a.globals.yAxisScale[0].niceMin +
														(l.bottom - h.bottom) * s.yRatio[0]),
												  (n =
														a.globals.yAxisScale[0].niceMax -
														(h.top - l.top) * s.yRatio[0]));
											var c = {
												xaxis: { min: t, max: e },
												yaxis: { min: o, max: n },
											};
											a.config.chart.events.selection(i.ctx, c),
												a.config.chart.brush.enabled &&
													...
													a.config.chart.events.brushScrolled(i.ctx, c);
										},
										o
									)));
						},
						...
						value: function (t) {
							...
							if (
								...
								if (a.globals.zoomEnabled) {
									...
									(v = { min: h, max: c }),
										("xy" !== i && "y" !== i) ||
											(m = x.clone(a.config.yaxis)).forEach(function (t, e) {
				...
				r(t, [
					...
					},
					{
						...
						value: function (t, e) {
							...
							if (
								!c ||
								("column" !== c && "candlestick" !== c && "boxPlot" !== c)
							) {
								(s = null === (i = l[e][t]) || void 0 === i ? void 0 : i[0]),
									(r =
										(null === (a = l[e][t]) || void 0 === a ? void 0 : a[1]) ||
										0);
								...
								d &&
									...
									n.fixedTooltip || this.moveTooltip(s, r, h);
							}
						},
					},
					{
							...
							var i = this.w,
								...
								r =
									s >= 2 && s % 2 == 0
										...
										: Math.floor(s / 2) + 1;
							i.globals.isBarHorizontal &&
								(r = new W(this.ctx).getActiveConfigSeriesIndex("desc") + 1);
						...
						value: function (t, e, i) {
							...
							if (a.yaxisTooltips[t] && o.length > 0) {
								...
								var d = (e - l.top) * i.yRatio[c],
									...
									u = r.minYArr[h] + (g - d);
								s.config.yaxis[t].reversed && (u = r.maxYArr[h] - (g - d)),
									a.tooltipPosition.moveYCrosshairs(e - l.top),
									(a.yaxisTooltipText[t].innerHTML = n(u)),
				...
				r(t, [
					{
						...
						value: function (t) {
							...
							v.globals.isXNumeric && !v.globals.isBarHorizontal
								? ((e = a + parseFloat(u * (x + 1))),
								  (i = s + parseFloat(g * (x + 1)) - w))
								: ((e = a + parseFloat(u * x)), (i = s + parseFloat(g * x)));
							var k,
								A = null,
								S = a,
								C = s,
							...
							void 0 !== f && this.barCtx.isRangeBar && ((i = f), (C = f)),
								void 0 !== p &&
							...
							if (v.config.dataLabels.enabled) {
								...
								X = y.getTextRects(
									v.globals.yLabelFormatters[0](E),
					...
					},
					{
						...
						value: function (t) {
							...
							var L = this.barCtx.series[s][r] < 0,
								P = l;
							switch (
								(this.barCtx.isReversed && ((P = l + (L ? d : -d)), (l -= d)),
								x.position)
							) {
								case "center":
									p = A
					...
					},
					{
						...
						value: function (t) {
							...
							if (this.barCtx.lastActiveBarSerieIndex === r && f.enabled) {
								...
								S
									? ((y = C - g - x - f.offsetX), (A = "end"))
									: (y =
											C +
											x +
											f.offsetX +
											(this.barCtx.isReversed ? -(h + g) : g)),
									(w = k - c.height / 2 + L.height / 2 + f.offsetY + g);
							}
							return (
							...
							return (
								h.enabled &&
									...
									(e = d.drawText({
										x:
											i -
											(!c.globals.isBarHorizontal && c.globals.barGroups.length
												? (r * (c.globals.barGroups.length - 1)) / 2
												: 0),
										y:
											a -
											(c.globals.isBarHorizontal && c.globals.barGroups.length
												? (o * (c.globals.barGroups.length - 1)) / 2
												: 0),
						...
						value: function (t) {
							...
							if (
								(d.globals.previousPaths.length > 0 &&
									(y = this.barCtx.getPreviousPath(l, c, !1)),
								(v =
									v +
									g.line(x, r) +
									g.line(b, r) +
								...
								var k = this.barCtx;
								(k = this.barCtx[n]).yArrj.push(r - f),
									k.yArrjF.push(Math.abs(s - r + o)),
									k.yArrjVal.push(this.barCtx.series[h][c]);
							}
					...
					},
					{
						...
						value: function (t) {
							...
							if (
								...
								var k = this.barCtx;
								(k = this.barCtx[n]).xArrj.push(r + f),
									k.xArrjF.push(Math.abs(s - r)),
									k.xArrjVal.push(this.barCtx.series[h][c]);
							}
							return { pathTo: v, pathFrom: y };
						},
					},
						...
						value: function (t, i, a, s, r, n) {
								...
								d = function (e, s) {
									...
									c.push(
										(o(
											...
											t,
											"x" === t
												? l.getXForValue(e, i, !1)
												: l.getYForValue(e, a, n, !1)
										),
										o(r, "attrs", s),
										r)
									);
							...
							if (
								(h.globals.seriesGoals[s] &&
									h.globals.seriesGoals[s][r] &&
									Array.isArray(h.globals.seriesGoals[s][r]) &&
									h.globals.seriesGoals[s][r].forEach(function (t) {
										d(t.value, t);
									}),
								this.barCtx.barOptions.isDumbbell &&
									h.globals.seriesRange.length)
							) {
								var g = this.barCtx.barOptions.dumbbellColors
				...
				r(t, [
					{
						...
						value: function (t, i) {
							...
							for (var n = 0, l = 0; n < t.length; n++, l++) {
								...
								this.ctx.series.addCollapsedClassToSeries(k, v),
									t[n].length > 0 && (this.visibleI = this.visibleI + 1);
								var A = 0,
									S = 0;
								this.yRatio.length > 1 &&
									((this.yaxisIndex = a.globals.seriesYAxisReverseMap[v]),
								...
								a.globals.delayedElements.push({ el: I.node }),
									...
									this.isHorizontal
										? ((X = this.drawBarPaths(
												e(
													e({}, E),
													{},
													{ barHeight: A, zeroW: g, yDivision: c }
												)
										  )),
										  (S = this.series[n][T] / this.invertedYRatio))
										: ((X = this.drawColumnPaths(
												e(e({}, E), {}, { xDivision: h, barWidth: S, zeroH: d })
										  )),
					...
					},
					{
						...
						value: function (t) {
							...
							if (!a) {
								var I =
									"function" == typeof P.globals.stroke.colors[e]
										? (function (t) {
												var e,
							...
							X.count > 0 &&
								...
								(z.node.setAttribute("stroke-dasharray", X.dashArray),
								z.node.setAttribute("stroke-width", X.strokeWidth),
								z.node.setAttribute("fill-opacity", X.fillOpacity)),
								void 0 !== u &&
									void 0 !== p &&
									(z.attr("data-range-y1", u), z.attr("data-range-y2", p)),
								new v(this.ctx).setSelectionFilter(z, e, s),
								c.add(z);
							...
							return (
								null !== E.dataLabels && k.add(E.dataLabels),
								E.totalDataLabels && k.add(E.totalDataLabels),
								c.add(k),
								A && c.add(A),
								S && c.add(S),
								c
					...
					},
					{
						...
						value: function (t) {
							...
							if (c.globals.isXNumeric) {
								...
								var b = this.barHelpers.getZeroValueEncounters({ i: u, j: p }),
									v = b.nonZeroColumns,
									m = b.zeroEncounters;
						...
						value: function (t) {
							...
							return (
								r.globals.seriesX[a].length ||
									(o = r.globals.maxValsInArrayIndex),
								r.globals.seriesX[o][s] &&
									(e =
										(r.globals.seriesX[o][s] - r.globals.minX) / this.xRatio -
										(i * this.seriesLen) / 2),
				...
				r(s, [
								...
								var o = this.graphics.group({
									...
									h = function (r, h) {
										...
										var m = [],
											...
											w = 0;
										a.yRatio.length > 1 &&
											((a.yaxisIndex = s.globals.seriesYAxisReverseMap[p][0]),
											(w = p)),
											(a.isReversed =
										...
										(l = P.y),
											...
											(c = P.xDivision),
											(g = P.zeroH),
											(s.globals.barHeight = C),
											(s.globals.barWidth = L),
										...
										for (var M = 0; M < s.globals.dataPoints; M++) {
											var I = a.barHelpers.getStrokeWidth(r, M, p),
												...
												z = null;
											a.isHorizontal
												? ((z = a.drawStackedBarPaths(
														e(
															e({}, T),
															{},
															{ zeroW: u, barHeight: C, yDivision: d }
														)
												  )),
												  (L = a.series[r][M] / a.invertedYRatio))
												: ((z = a.drawStackedColumnPaths(
														e(
															e({}, T),
															{},
															{ xDivision: c, barWidth: L, zeroH: g }
														)
												  )),
										...
										(s.globals.seriesXvalues[p] = m),
											(s.globals.seriesYvalues[p] = y),
					...
					},
					{
						...
						value: function (t) {
							...
							for (
								var b, v = i + n * r, m = 0, y = 0;
								y < this.groupCtx.prevYF.length;
								y++
							)
								m += isNaN(this.groupCtx.prevYF[y][g])
									? 0
									: this.groupCtx.prevYF[y][g];
							var w = d;
							if (
								...
								(w > 0 && !c.globals.isXNumeric) ||
									(w > 0 &&
										...
										c.globals.seriesX[p - 1][g] === c.globals.seriesX[p][g]))
							) {
								var k,
									A,
									S,
								...
								if (
									...
									for (var L = 1; L < C; L++) {
										...
										if (
											!isNaN(
												null === (P = this.groupCtx.prevY[w - L]) ||
													void 0 === P
													? void 0
													: P[g]
											)
								...
								for (var M = 1; M < C; M++) {
									var I, T;
									if (
										(null === (I = this.groupCtx.prevYVal[w - M]) ||
										void 0 === I
											? void 0
											: I[g]) < 0
									) {
										A =
											this.series[d][g] >= 0
												? S - m + 2 * (this.isReversed ? m : 0)
												: S;
										break;
									}
									if (
										(null === (T = this.groupCtx.prevYVal[w - M]) ||
										void 0 === T
											? void 0
											: T[g]) >= 0
									) {
							...
							a = this.series[d][g]
								? b -
								  this.series[d][g] / this.yRatio[f] +
								  2 * (this.isReversed ? this.series[d][g] / this.yRatio[f] : 0)
								: b;
							...
							for (
								var c = o.group({
									...
									d = function (i) {
										...
										s.ctx.series.addCollapsedClassToSeries(y, v),
											t[i].length > 0 && (s.visibleI = s.visibleI + 1);
										var w,
											k,
											A = 0;
										s.yRatio.length > 1 &&
											((s.yaxisIndex = r.globals.seriesYAxisReverseMap[v][0]),
											(A = v));
													...
													(c = s.isHorizontal
														? s.drawHorizontalBoxPaths(
																e(
																	e({}, x),
																	{},
																	{ yDivision: h, barHeight: w, zeroW: g }
																)
														  )
														: s.drawVerticalBoxPaths(
																e(
																	e({}, x),
																	{},
																	{ xDivision: n, barWidth: k, zeroH: d }
																)
														  )),
														(p = c.y),
														(u = c.x),
		...
		Lt = (function () {
			function t(e) {
				...
				(this.translateX = r - r * s),
					(this.translateY = o - o * s),
					(this.dataLabelsGroup = new m(this.ctx).group({
						...
						value: function (t) {
							...
							if (i.globals.dataChanged) {
								for (
									...
									g += x.negToZero(i.globals.previousPaths[u]);
								for (var p = 0; p < i.globals.previousPaths.length; p++)
									(d =
										(this.fullAngle * x.negToZero(i.globals.previousPaths[p])) /
										g),
							...
							return (
								(e =
									"donut" === i.chartType
										...
										? []
												.concat(y, ["L", i.centerX, i.centerY, "L", d, g])
												.join(" ")
										: [].concat(y).join(" ")),
			...
			function t(e) {
				...
				(this.graphics = new m(this.ctx)),
					...
					(this.maxValue = this.isLog
						? this.coreUtils.getLogVal(this.logBase, i.globals.maxY, 0)
						: i.globals.maxY),
								...
								i.globals.labels.forEach(function (o, n) {
									...
									if (r[n]) {
										...
										h.plotDataLabelsText({
											...
											if (
												"function" ==
												typeof i.config.chart.events.xAxisLabelClick
											) {
					...
					},
					{
						...
						value: function (t) {
							...
							if (this.radialDataLabels.show) {
								var p = e.globals.dom.Paper.select(
									".apexcharts-datalabels-group"
								).members[0];
							...
							for (
								var b = f ? t.series.length - 1 : 0;
								f ? b >= 0 : b < t.series.length;
								f ? b-- : b++
							) {
								var y = i.group({
								...
								r.add(y),
									y.attr({ rel: b + 1, "data:realIndex": b }),
								...
								e.globals.dataChanged &&
									...
									(L =
										Math.round(
											(this.totalAngle *
												x.negToZero(e.globals.previousPaths[b])) /
												100
										) + A)),
									Math.abs(C) + Math.abs(k) >= 360 && (C -= 0.01),
									Math.abs(L) + Math.abs(A) >= 360 && (L -= 0.01);
								var P = C - k,
									M = Array.isArray(e.config.stroke.dashArray)
										? e.config.stroke.dashArray[b]
								...
								if (
									...
									var Y = this.barLabels.useSeriesColors
										? e.globals.colors[b]
									...
									D.on("click", this.onBarLabelClick),
										D.attr({ rel: b + 1 }),
										0 !== k &&
											D.attr({
								...
								!this.initialAnim ||
									e.globals.resized ||
									e.globals.dataChanged ||
									(O = e.config.chart.animations.speed),
									e.globals.dataChanged &&
										(O = e.config.chart.animations.dynamicAnimation.speed),
									(this.animDur = O / (1.2 * t.series.length) + this.animDur),
									this.animBeginArr.push(this.animDur),
									this.animatePaths(I, {
										centerX: t.centerX,
										centerY: t.centerY,
						...
						value: function (t, i) {
							...
							for (
								...
								var b = 0,
									...
									y = 0;
								this.yRatio.length > 1 &&
									((this.yaxisIndex = a.globals.seriesYAxisReverseMap[u][0]),
									(y = u));
								...
								for (
									var k = s.group({
										...
										A = s.group({ class: "apexcharts-rangebar-goals-markers" }),
										S = 0;
									...
									var C = this.barHelpers.getStrokeWidth(o, S, u),
										...
										I = null,
										T = null,
										z = { x: d, y: g, strokeWidth: C, elSeries: f },
										X = this.seriesLen;
									if (
										(a.config.plotOptions.bar.rangeBarGroupRows && (X = 1),
									...
									if (this.isHorizontal) {
										...
										a.globals.isXNumeric &&
											(d =
												(a.globals.seriesX[o][S] - a.globals.minX) /
													this.xRatio -
												v / 2),
											(I = d + v * this.visibleI);
										var F = (n - v * X) / 2;
									...
									? ((a = g.config.plotOptions.bar.rangeBarGroupRows
									  ...
									  v > -1 &&
											...
											(a =
												...
												h * b))
									: (b > -1 &&
											!g.globals.timescaleLabels.length &&
										...
										(!this.w.config.chart.stackOnlyBar ||
											...
											"column" ===
												(null === (i = this.w.config.series[r]) || void 0 === i
													...
													: i.type)));
							if (
								void 0 !== (null === (a = o[s]) || void 0 === a ? void 0 : a[0])
							)
								n =
									(l =
										d && s > 0
						...
						for (var d = [], g = 0; g < t.length; g++) {
							...
							this.ctx.series.addCollapsedClassToSeries(this.elSeries, u),
								o.globals.isXNumeric &&
									...
									(v =
										(o.globals.seriesX[u][0] - o.globals.minX) / this.xRatio),
								b.push(v);
							var w,
								k = v,
								A = void 0,
							...
							(C = this.lineHelpers.determineFirstPrevY({
								...
								"monotoneCubic" === o.config.stroke.curve && null === t[g][0]
									? f.push(null)
									: f.push(C),
								(w = C);
							"rangeArea" === l &&
							...
							if ("rangeArea" === l) {
								for (
									var X = this._calculatePathsFrom({
											series: s,
											i: g,
											realIndex: u,
											prevX: S,
										...
										Y = z.linePaths.length / 2,
										F = 0;
									F < Y;
									F++
								)
									z.linePaths[F] = E.linePaths[F + Y] + z.linePaths[F];
								z.linePaths.splice(Y),
									(z.pathFromLine = E.pathFromLine + z.pathFromLine);
							} else z.pathFromArea += "z";
							this._handlePaths({ type: l, realIndex: u, i: g, paths: z }),
					...
					value: function (t) {
						...
						if (null === o[n][0]) {
							for (var f = 0; f < o[n].length; f++)
								if (null !== o[n][f]) {
									(c = this.xDivision * f),
										(d = this.zeroY - o[n][f] / this.yRatio[h]),
										(e = p.move(c, d)),
						...
						if (
							((a = p.move(0, this.zeroY) + p.line(0, this.zeroY)),
							(s = p.move(0, this.zeroY) + p.line(0, this.zeroY)),
				...
				},
				{
					...
					value: function (t) {
						var e,
							...
							X = p.pathFromLine,
							E = p.pathFromArea,
							Y = x.isNumber(L.globals.minYArr[n])
								? L.globals.minYArr[n]
								: L.globals.minY;
						o ||
							(o =
						...
						var F = function (t, e) {
							...
							H =
								...
								(L.config.chart.stacked &&
									...
									(!this.w.config.chart.stackOnlyBar ||
										"bar" ===
											(null === (e = this.w.config.series[n]) || void 0 === e
												? void 0
												: e.type) ||
										"column" ===
											(null === (i = this.w.config.series[n]) || void 0 === i
												? void 0
												: i.type))),
						...
						for (var O, N = 0, W = 0; W < o; W++) {
							...
							if (L.globals.isXNumeric) {
								...
								void 0 === L.globals.seriesX[n][W + 1] &&
									(G = L.globals.seriesX[n][o - 1]),
									(c = (G - L.globals.minX) / this.xRatio);
							} else c += this.xDivision;
							if (H)
								if (
									h > 0 &&
									L.globals.collapsedSeries.length < L.config.series.length - 1
								) {
									y =
										this.prevSeriesY[
											(function (t) {
							...
							B
								? (d = F(Y, y))
								: ((d = F(r[h][W + 1], y)),
								  "rangeArea" === s && (R = F(C[h][W + 1], y))),
								w.push(c),
								!B ||
								("smooth" !== L.config.stroke.curve &&
									"monotoneCubic" !== L.config.stroke.curve)
									? (k.push(d), A.push(R))
									: (k.push(null), A.push(null));
							...
							(b = j.areaPaths),
								...
								(T = j.linePath),
								!this.appendPathFrom ||
									("monotoneCubic" === D && "rangeArea" === s) ||
									((X += P.line(c, this.zeroY)), (E += P.line(c, this.zeroY))),
								this.handleNullDataPoints(r, V, h, W, n),
							...
							case "monotoneCubic":
								...
								switch (u) {
									case 0:
										...
										u = 1;
									case 1:
										if (!(C ? n.length === i[a].length : s === i[a].length - 2))
											break;
									case 2:
								...
								if (null === i[a][s]) u = 0;
									...
									switch (u) {
										case 0:
											if (
												((p = d),
												(f = L ? A.move(d, c[s]) + A.line(d, g) : A.move(d, g)),
												(x = A.move(d, g)),
												(u = 1),
												s < i[a].length - 2)
											) {
										...
										case 1:
											if (null === i[a][s + 1])
												(f += L ? A.line(d, h) : A.move(d, g)),
													(x += A.line(d, S) + A.line(p, S) + "z"),
													b.push(f),
													v.push(x),
													(u = -1);
											else {
												...
												(f += D),
													...
													s >= i[a].length - 2 &&
														(L &&
															(f += A.curve(r, o, r, o, r, h) + A.move(r, h)),
														(x +=
															A.curve(r, o, r, o, r, S) + A.line(p, S) + "z"),
														b.push(f),
														v.push(x),
														(u = -1));
											}
						...
						value: function (t, e) {
							...
							s.series.forEach(function (e, a) {
								...
								switch (u) {
									...
									case "rangeBar":
										...
										break;
									case "rangeArea":
										p.series.push(s.seriesRangeStart[a]),
											p.seriesRangeEnd.push(s.seriesRangeEnd[a]),
											p.i.push(a);
										break;
									case "heatmap":
									case "treemap":
								...
								s.comboCharts || (s.comboCharts = b > 0);
							...
							if (s.comboCharts) {
								...
								if (o.series.length > 0)
									(S = A).push.apply(
										S,
										u(L.drawSeriesByGroup(o, s.areaGroups, "area", v))
									);
								if (h.series.length > 0)
									if (i.config.chart.stacked) {
										...
										(this.ctx.bar = new yt(this.ctx, e)),
											A.push(this.ctx.bar.draw(h.series, h.i));
								if (
									(p.series.length > 0 &&
										A.push(
											v.draw(p.series, "rangeArea", p.i, p.seriesRangeEnd)
										),
									r.series.length > 0)
								)
									(C = A).push.apply(
										C,
										u(L.drawSeriesByGroup(r, s.lineGroups, "line", v))
									);
								if (
									(c.series.length > 0 &&
										A.push(m.draw(c.series, "candlestick", c.i)),
									d.series.length > 0 &&
										A.push(m.draw(d.series, "boxPlot", d.i)),
									g.series.length > 0 &&
										A.push(this.ctx.rangeBar.draw(g.series, g.i)),
									n.series.length > 0)
								) {
			...
			(a.PathArray = function (t, e) {
					...
					extend: {
						...
						svg: function (t) {
							...
							if (!(t && this instanceof a.Parent))
								return (
									i.appendChild(
										(t = e.createElementNS("http://www.w3.org/2000/svg", "svg"))
									),
									this.writeDataToDom(),
				...
				(a.on = function (t, e, i, s, r) {
					...
					(a.listeners[n] = a.listeners[n] || {}),
						...
						t.addEventListener(l, o, r || { passive: !1 });
				}),
					...
					case "A":
						(e = (function (t, e) {
							...
							(i = new SVG.Point((F.x - R.x) / 2, (F.y - R.y) / 2).transform(
								new SVG.Matrix().rotate(T)
							)),
								(a = (i.x * i.x) / (M * M) + (i.y * i.y) / (I * I)) > 1 &&
									((M *= a = Math.sqrt(a)), (I *= a));
							(s = new SVG.Matrix()
								.rotate(T)
								.scale(1 / M, 1 / I)
				...
				r(t, [
					{
						...
						value: function () {
							(this.ctx.publicMethods = [
								...
								(this.ctx.updateHelpers = new Gt(this.ctx)),
				...
				[
					...
					},
					{
						...
						value: function (t, e) {
							...
							i.config.xaxis.convertedCatToNumeric) &&
								new E(i.config).convertCatToNumericXaxis(i.config, this.ctx);
							...
							(0 === t.length || (r && a.collapsedSeries.length < 1)) &&
					...
					},
					{
						...
						value: function () {
							...
							window.removeEventListener("resize", this.windowResizeHandler),
								...
								(e = _t.get(t)) && (e.disconnect(), _t.delete(t));
