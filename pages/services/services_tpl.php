...
<section class="services-detail" id="ttp-connect">
    <div class="container">
        ...
        <div class="service-hero-image">
            ...
            <?php if (!empty($ttp_connect_header['photo'])): ?>
                <img src="<?= UPLOAD_NEWS_L . $ttp_connect_header['photo'] ?>" 
                     alt="<?= $ttp_connect_header['namevi'] ?>"
...
<section class="services-detail alt" id="ttp-data">
    <div class="container">
        ...
        <div class="service-hero-image">
            ...
            <?php if (!empty($ttp_data_header['photo'])): ?>
                <img src="<?= UPLOAD_NEWS_L . $ttp_data_header['photo'] ?>" 
                     alt="<?= $ttp_data_header['namevi'] ?>"
                     style="width: 100%; height: 100%; object-fit: cover;">
            <?php else: ?>
            <div class="image-placeholder">
        ...
        <!-- Advantages -->
        <?php if (!empty($advantages_header) || !empty($advantages_items)): ?>
        <div class="advantages-box">
            ...
            <?php if (!empty($advantages_header)): ?>
            <div class="advantages-header">
                ...
                <h3><?= $advantages_header['namevi'] ?></h3>
                <?php if (!empty($advantages_header['descvi'])): ?>
                    <p style="margin-top: 8px; opacity: 0.8;"><?= $advantages_header['descvi'] ?></p>
                <?php endif; ?>
            </div>
            <?php endif; ?>

            <div class="advantages-grid">
                <?php if (!empty($advantages_items)): foreach ($advantages_items as $adv): ?>
...
<section class="services-detail" id="ttp-cloud">
    <div class="container">
        ...
        <div class="service-hero-image">
            ...
            <?php if (!empty($ttp_cloud_header['photo'])): ?>
                <img src="<?= UPLOAD_NEWS_L . $ttp_cloud_header['photo'] ?>" 
                     alt="<?= $ttp_cloud_header['namevi'] ?>"
                     style="width: 100%; height: 100%; object-fit: cover;">
            <?php else: ?>
                <div class="image-placeholder">
                    <div class="no-image-icon">☁️</div>
        ...
        <!-- Why Choose Cloud -->
        <?php if (!empty($why_cloud_header) || !empty($why_cloud_items)): ?>
        <div class="why-cloud-section">
            <?php if (!empty($why_cloud_header)): ?>
            ...
            <h3 class="why-cloud-title">
                <?= $why_cloud_header['namevi'] ?>
            </h3>
            <?php if (!empty($why_cloud_header['descvi'])): ?>
            <p class="why-cloud-description">
                <?= $why_cloud_header['descvi'] ?>
            </p>
            <?php endif; ?>
            <?php endif; ?>

            <div class="why-cloud-grid">
                <?php if (!empty($why_cloud_items)): foreach ($why_cloud_items as $why): ?>
...
<section class="services-detail alt" id="ttp-infra">
    <div class="container">
        ...
        <div class="service-hero-image">
            ...
            <?php if (!empty($ttp_infra_header['photo'])): ?>
                <img src="<?= UPLOAD_NEWS_L . $ttp_infra_header['photo'] ?>" 
                     alt="<?= $ttp_infra_header['namevi'] ?>"
                     style="width: 100%; height: 100%; object-fit: cover;">
            <?php else: ?>
                <div class="image-placeholder">
                    <div class="no-image-icon">🔧</div>
...
<?php if (!empty($process_header) || !empty($process_steps)): ?>
<section class="process-steps">
    <div class="container">
        <?php if (!empty($process_header)): ?>
        <div class="section-header">
            <div class="section-badge">
                ...
                <span><?= $process_header['namevi'] ?></span>
            </div>

            <h2 class="section-title">
                <?= $process_header['descvi'] ?>
            </h2>
        </div>
        <?php endif; ?>
